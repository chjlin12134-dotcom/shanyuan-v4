...
def format_retrieved(items: list[dict], buddhist_mode: bool = False) -> str:
    ...
    blocks.append(
        ...
        "拿不準到底是 (1) 還是 (2) 的時候，一律當作 (2) 處理：先誠實講成「受大師啟發、我自己的體會」，"
    ...
    if buddhist_mode:
        ...
        if verified:
            ...
            source_check_instruction = (
                ...
                "要老實承認這是你受大師啟發、長期熏習之後融匯在自己身上的體會，例如「我這一刻不能完全確定原話怎麼說，"
                "但這是我從大師這邊熏習所受到的啟發」這種既不逐字引用、也不否認淵源的講法，不要把大師教導的功勞講成完全是你自己原創的。"
